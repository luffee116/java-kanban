...
class TaskTest {
    ...
    @BeforeEach
    void init() {
        task1 = new Task(1, "Помыть пол", "Начисто", Status.NEW, Duration.ofHours(1), LocalDateTime.of(2025, 2, 20, 10, 0));
        task2 = new Task(1, "noTest", "noTest", Status.NEW, Duration.ofHours(1), LocalDateTime.of(2025, 2, 3, 1, 1));
    }
