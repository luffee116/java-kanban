...
public class InMemoryHistoryManagerTest {
    ...
    public void testAddTaskAndGetTask() {
        ...
        String expected = "[Task{id=1, title='Молоко', description='Купить', status=NEW, duration=PT10M, timeStart=01:01:00/01.01.2002, timeEnd=01:11:00/01.01.2002}, Task{id=2, title='Машина', description='Помыть', status=IN_PROGRESS, duration=PT10M, timeStart=02:02:00/02.02.2002, timeEnd=02:12:00/02.02.2002}, Epic{subtasksId=[], id=3, title='Домашка', description='Выполнить', status=NEW, duration=PT10M, timeStart=01:01:00/01.01.0001, timeEnd=01:11:00/01.01.0001}, Epic{subtasksId=[], id=4, title='Уборка', description='Убраться дома', status=NEW, duration=PT10M, timeStart=02:01:00/01.01.0001, timeEnd=02:11:00/01.01.0001}, Subtask{epicID=3, id=5, title='Доделать спринт', description='Быстро', status=IN_PROGRESS, duration=PT10M, timeStart=03:03:00/03.03.2002, timeEnd=03:13:00/03.03.2002}, Subtask{epicID=4, id=6, title='Помыть полы', description='До прихода гостей', status=DONE, duration=PT10M, timeStart=04:04:00/04.04.2002, timeEnd=04:14:00/04.04.2002}]";
